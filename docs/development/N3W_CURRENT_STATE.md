...
CURRENT_NEXT_GATE=N3W_PRODUCTION_MULTI_RELAY_GATEWAY_SELECTION_V1_BOARD_C_N3W_REPROVISION_20260923_01
```

Authority: `docs/development/N3W_PRODUCTION_RELAY_DISCOVERY_CHANNEL_COVERAGE_FALLBACK_V1_DEFERRED_DECISION_20260923.md`.

## 2026-09-23 Board C Wi-Fi reprovision closure
...
Authority: `docs/development/N3W_PRODUCTION_MULTI_RELAY_GATEWAY_SELECTION_V1_BOARD_C_WIFI_REPROVISION_CLOSURE_20260923.md`.

## 2026-09-23 Board C APP1 stale-image closure

```text
BOARD_C_RUNNING_APP_SLOT=APP0
BOARD_C_APP1_STALE_IMAGE_PRESENT=false
BOARD_C_APP1_ALL_FF_AFTER_ERASE=true
BOARD_C_APP0_SHA256=c98010719f37af69142a0ee318ff1577a064215e580b5182dc98556b11560a5a
BOARD_C_APP0_EXACT_FIRMWARE_PRESERVED=true
BOARD_C_APP0_MUTATION=false
BOARD_C_OTADATA_MUTATION=false
BOARD_C_NVS_MUTATION=false
BOARD_C_PARTITION_TABLE_MUTATION=false
BOARD_C_FULL_FLASH_ERASE=false
...
Authority: `docs/development/N3W_PRODUCTION_MULTI_RELAY_GATEWAY_SELECTION_V1_BOARD_C_APP1_STALE_IMAGE_ERASE_CLOSURE_20260923.md`.

## 2026-09-23 GWSEL V1 A-Child / B+C-Gateways role-swap snapshot
...
BOARD_C_POWER_INSTABILITY=PRIMARY_PHYSICAL_CONFOUNDER_FOR_OLD_CHILD_ROUTE
...
NEXT_ONE_GATE=N3W_PRODUCTION_MULTI_RELAY_GATEWAY_SELECTION_V1_A_CHILD_BC_GATEWAYS_DIRECT_REBASELINE_20260923_01
```

Authority: `docs/development/N3W_PRODUCTION_MULTI_RELAY_GATEWAY_SELECTION_V1_A_CHILD_BC_GATEWAYS_ROLE_SWAP_REPLAN_20260923.md`.

## 2026-09-23 GWSEL V1 P1B Relay-log forensic snapshot
...
Authority: `docs/development/N3W_PRODUCTION_MULTI_RELAY_GATEWAY_SELECTION_V1_P1_GATEWAY_B_PRE_REBOOT_RELAY_LOG_FORENSIC_CLOSURE_20260923.md`.

## 2026-09-23 GWSEL V1 P1B reboot-during-qualification snapshot
...
NEXT_ONE_GATE=N3W_PRODUCTION_MULTI_RELAY_GATEWAY_SELECTION_V1_P1_GATEWAY_B_REBOOT_CAUSE_REVIEW_20260923_01
```

Authority: `docs/development/N3W_PRODUCTION_MULTI_RELAY_GATEWAY_SELECTION_V1_P1_GATEWAY_B_REBOOT_DURING_QUALIFICATION_20260923.md`.
