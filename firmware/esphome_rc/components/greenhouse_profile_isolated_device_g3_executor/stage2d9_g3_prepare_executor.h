...
class Stage2D9G3PrepareExecutor final : public Component {
 public:
 ...
 protected:
  ...
  bool parse_command_(const std::string &line,
                      Stage2D9CommandEnvelope *envelope) const;
  bool execute_prepare_(Stage2D9CommandEnvelope *envelope);
  bool execute_verify_(Stage2D9CommandEnvelope *envelope);
  bool verify_recovered_candidate_(const Stage2D9CommandEnvelope &envelope,
  ...
  bool expected_candidate_digest_(const Stage2D9CommandEnvelope &envelope,
                                  std::string *digest) const;
  void read_console_();
