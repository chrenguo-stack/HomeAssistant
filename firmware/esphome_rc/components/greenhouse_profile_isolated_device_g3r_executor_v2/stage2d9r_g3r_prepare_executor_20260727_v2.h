...
// Byte-for-byte behavior is supplied by the frozen V1 implementation, compiled
// under these independent V2Core symbols in the V2 translation unit.
struct Stage2D9RCommandEnvelopeV2 {
...
class Stage2D9RG3RPrepareExecutorV2Core : public Component {
 public:
 ...
 protected:
  ...
  bool parse_command_(const std::string &line,
                      Stage2D9RCommandEnvelopeV2 *envelope) const;
  bool parse_prepare_(const std::vector<std::string> &fields,
                      Stage2D9RCommandEnvelopeV2 *envelope) const;
  bool parse_verify_(const std::vector<std::string> &fields,
                     Stage2D9RCommandEnvelopeV2 *envelope) const;
  bool execute_prepare_(Stage2D9RCommandEnvelopeV2 *envelope);
  bool execute_verify_(Stage2D9RCommandEnvelopeV2 *envelope);
