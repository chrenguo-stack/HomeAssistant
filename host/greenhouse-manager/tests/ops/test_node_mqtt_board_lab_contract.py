...
MODULE = ROOT / "host/greenhouse-manager/src/greenhouse_manager/ops/node_mqtt_board_lab.py"
SUPPORT_MODULES = tuple(
    ROOT / f"host/greenhouse-manager/src/greenhouse_manager/ops/{name}"
    for name in (
...
TESTS = ROOT / "host/greenhouse-manager/tests/ops/test_node_mqtt_board_lab.py"
