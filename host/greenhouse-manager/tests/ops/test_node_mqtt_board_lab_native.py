...
from greenhouse_manager.ops import node_mqtt_board_lab_native_broker as native
from greenhouse_manager.ops.node_mqtt_board_lab_common import (
    CONFIRMATION,
...
def test_native_cli_and_public_contract_are_registered() -> None:
    ...
    assert (
        ...
        == "greenhouse_manager.ops.node_mqtt_board_lab_native:main"
    )
    source = (
        root / "src/greenhouse_manager/ops/node_mqtt_board_lab_native_broker.py"
