...
from greenhouse_manager.ops import node_mqtt_board_lab_native as native_cli
from greenhouse_manager.ops.node_mqtt_board_lab_common import NodeMqttBoardLabError
...
def test_private_mosquitto_cli_is_registered() -> None:
    ...
    assert (
        ...
        == "greenhouse_manager.ops.node_mqtt_private_mosquitto:main"
    )
