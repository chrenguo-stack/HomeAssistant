...
from greenhouse_manager.ops.t1_broker_identity_production_executor_contract import (
...
def test_module_imports_without_paho() -> None:
    ...
    script = textwrap.dedent(
        ...
        from greenhouse_manager.ops.t1_broker_identity_production_executor_contract import SCHEMA
