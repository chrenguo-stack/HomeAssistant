...
import greenhouse_manager.ops.t1_client_migration_audit as audit
from greenhouse_manager.ops.t1_client_migration_audit import (
...
def test_client_migration_audit_imports_without_paho() -> None:
    ...
    script = textwrap.dedent(
        ...
        from greenhouse_manager.ops.t1_client_migration_audit import AUDIT_SCHEMA
