...
from greenhouse_manager.ops import t1_homeassistant_mqtt_migration_material_evidence_v2 as module
from greenhouse_manager.ops.t1_homeassistant_mqtt_migration_material_evidence import (
    CandidateMaterial,
)
