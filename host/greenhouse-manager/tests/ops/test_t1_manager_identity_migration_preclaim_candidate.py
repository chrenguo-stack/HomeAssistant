...
import greenhouse_manager.ops.t1_manager_identity_migration_preclaim_candidate as module
from greenhouse_manager.ops.t1_manager_identity_migration_preclaim_candidate import (
