...
from greenhouse_manager.ops.t1_backup import create_backup
from greenhouse_manager.ops.t1_migration_package import create_migration_package
from greenhouse_manager.ops.t1_migration_readiness import build_readiness_report
...
def test_readiness_imports_without_paho() -> None:
    ...
    script = textwrap.dedent(
        ...
        from greenhouse_manager.ops.t1_migration_readiness import REPORT_SCHEMA
