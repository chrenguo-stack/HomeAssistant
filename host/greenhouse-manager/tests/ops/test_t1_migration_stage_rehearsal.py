...
import greenhouse_manager.ops.t1_migration_stage_rehearsal as stage_rehearsal
from greenhouse_manager.ops.t1_migration_stage import MigrationStageError
from greenhouse_manager.ops.t1_shadow import ShadowError
...
def test_stage_rehearsal_module_imports_without_paho() -> None:
    ...
    script = textwrap.dedent(
        ...
        from greenhouse_manager.ops.t1_migration_stage_rehearsal import (
