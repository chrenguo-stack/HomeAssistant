...
TOOL = ROOT / "tools/h3_n2_stage2d9r_g3r_d2_17_g10_target_mac_static_check_acceptance_contract_20260731_v1.py"
ACCEPTANCE = ROOT / "docs/acceptance/h3-n2-stage2d9r-g3r-d2-17-g10-target-mac-static-check-pass-20260731-v1.json"
PENDING = ROOT / "docs/decisions/h3-n2-stage2d9r-g3r-d2-17-g10-physical-execution-pending-20260731-v1.json"

spec = importlib.util.spec_from_file_location("g10_acceptance", TOOL)
...
def expect_failure(fn, value, code_prefix: str) -> None:
    try:
        fn(value)
    except module.G10AcceptanceError as exc:
...
def main() -> int:
    ...
    changed["marker_digest_compatibility_verified"] = False
