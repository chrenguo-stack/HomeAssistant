...
def probe_board(port: str) -> dict[str, object]:
    ...
    with tempfile.TemporaryDirectory(prefix="n3w-gwsel-v1-board-a-readback-") as td:
        root = Path(td)
...
def run_preflight(args: argparse.Namespace) -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="n3w-gwsel-v1-board-a-preflight-") as td:
    ...
    print("N3W_PRODUCTION_GWSEL_V1_BOARD_A_WRITE_TARGET_PREFLIGHT=PASS")
