#!/usr/bin/env python3
"""Run ESPHome 2026.4.3 with the frozen Stage2D9 build timestamp.
...
authorization. V68 intentionally retains the V67 fixed timestamp so repeated
builds remain deterministic while the unlock digest changes.
"""
