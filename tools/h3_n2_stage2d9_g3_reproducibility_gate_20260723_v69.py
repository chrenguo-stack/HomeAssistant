#!/usr/bin/env python3
"""Require two clean Stage2D9 G3 V69 builds to be byte-identical."""
...
def main() -> int:
    ...
    for role in ROLES:
        ...
        require(FIXED_BUILD_TIME_STR.encode("ascii") in firmware,
    ...
    report = {
        "schema": "gh.h3.n2.stage2d9-g3-reproducibility/3",
