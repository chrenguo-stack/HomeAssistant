...
DECISION_ID='D1-H3N2-STAGE2D9R-G3R-D2-17-G08-PHYSICAL-EXECUTION-20260731-01'
...
def main()->int:
 p=Path.home()/'.local/state/greenhouse-stage2d9r/d2-17-g08-physical-decisions'/(DECISION_ID+'.json')
