...
LEGACY_G07_AUTH_MARKER_SHA256='c9250960ee5418739cda4d670f01d215229386b7c44edde6c4738337658a359a'
...
def authorization_state_paths(home:Path,physical:Path)->tuple[Path,Path,Path]:
    ...
    isolated_root=physical/'authorization-state-g08'
...
def run(decision_root:Path)->int:
    ...
    physical=runtime/'D2_17_G08_PHYSICAL_EXECUTION_20260731_01'; terminal_path=physical/'D2_17_G08_PHYSICAL_DECISION_TERMINAL.json'; result_path=physical/'D2_17_G08_PHYSICAL_RESULT.json'; decision_marker=Path.home()/'.local/state/greenhouse-stage2d9r/d2-17-g08-physical-decisions'/(DECISION_ID+'.json')
    ...
    require(not physical.exists(),'PHYSICAL_RUNTIME_ROOT_ALREADY_EXISTS'); require(not decision_marker.exists(),'PHYSICAL_DECISION_ALREADY_USED'); require(not auth_marker.exists(),'G08_AUTHORIZATION_ALREADY_CLAIMED_OR_CONSUMED'); physical.mkdir(parents=True,mode=0o700); os.chmod(physical,0o700)
    ...
    try:
        ...
        require(sha(legacy_auth_marker)==LEGACY_G07_AUTH_MARKER_SHA256,'G07_LEGACY_AUTHORIZATION_MARKER_MODIFIED')
